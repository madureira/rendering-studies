...
REGISTER_DEMO(RippleEffect, false)
    ...
    , m_Frequency(5.0f)
{
    ...
    // Position in +X,+Y,+Z octant; yaw 225deg + pitch ~-35deg so front points at (0,0,0).
    ...
    m_Camera.OverrideInitialPosition(
        ...
        -35.264f // pitch: ~35deg down from horizontal (classic isometric)
    );
